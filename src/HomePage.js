    ...
    return (
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <section className="row text-center" style={{ padding: '50px 0', display: 'flex', justifyContent: 'space-between' }}>
          <div className="col-md-4">
            <div style={{ padding: '20px' }}>
              <img src={ExpensesImg} alt="Track Spending" style={{ width: '55%', height: 'auto' }} />
          ...
          <div className="col-md-4">
            <div style={{ padding: '20px' }}>
              <img src={Icon2} alt="Set Goals" style={{ width: '100%', height: 'auto' }} />
              <h2>Set Goals</h2>
          ...
          <div className="col-md-4">
            <div style={{ padding: '20px' }}>
              <img src={Icon3} alt="Reports" style={{ width: '100%', height: 'auto' }} />
        ...
        <section className="text-center" style={{ backgroundColor: '#D5FFDF', padding: '50px 0' }}>
          ...
          <div className="mt-4">
            <p>“The best part about MoneyTrail is that it syncs seamlessly between devices! My partner and I can track our spending together without any hassle. 
              It’s made budgeting a team effort.” — Sarah</p>
            <p>“With MoneyTrail, I finally feel in control of my spending. It’s helped me save more and cut out unnecessary expenses. I’m sticking with it!”
            — Arjun</p>
            <p>“MoneyTrail has been life-changing for our family’s finances. We’re finally on the same page with our budget and future goals. Thank you!”
            — Priya</p>
            <p>- Happy User</p>
          </div>
        </section>
